      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-3">
          ...
          <Button 
            ...
            className="bg-gradient-to-r from-emerald-600 to-emerald-500 hover:from-emerald-500 hover:to-emerald-400 text-white font-bold shadow-[0_0_10px_rgba(16,185,129,0.25)] dark:bg-gradient-to-r dark:from-[#10B981] dark:to-[#10B981] dark:hover:from-[#10B981]/90 dark:hover:to-[#10B981]/80 dark:text-black dark:shadow-[0_0_15px_rgba(16,185,129,0.4)]"
          >
      ...
      <div className="glass-card p-6 rounded-2xl border-accent/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div className="rounded-xl p-4 bg-muted/40 dark:bg-white/5 border border-border/40 dark:border-white/10 shadow-sm">
            ...
            <p className="text-2xl font-bold text-green-600 dark:text-[#10B981]">{formatAmount((budgetData?.totalIncome || 0))}</p>
          </div>
          <div className="rounded-xl p-4 bg-muted/40 dark:bg-white/5 border border-border/40 dark:border-white/10 shadow-sm">
                  ...
                  <div key={category.id} className="p-4 rounded-lg border border-border/50 hover:border-accent/30 transition-colors">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-emerald-500/20 to-emerald-400/30 dark:from-[#10B981]/20 dark:to-[#10B981]/30 flex items-center justify-center shadow-[0_0_10px_rgba(16,185,129,0.2)] dark:shadow-[0_0_10px_rgba(16,185,129,0.2)]">
                          <Icon className="w-5 h-5 text-emerald-600 dark:text-[#10B981]" />
                        </div>
                        <div>
                      ...
                      <div className="flex items-center gap-2">
                        <span className={`text-sm font-medium ${remaining >= 0 ? 'text-emerald-600 dark:text-[#10B981]' : 'text-red-400'}`}>
